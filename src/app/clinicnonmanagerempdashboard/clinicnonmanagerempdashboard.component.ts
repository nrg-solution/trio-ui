...
@Component({
  selector: 'app-clinicnonmanagerempdashboard',
  templateUrl: './clinicnonmanagerempdashboard.component.html',
  styleUrls: ['./clinicnonmanagerempdashboard.component.css']
})
export class ClinicnonmanagerempdashboardComponent implements OnInit {
  ...
  printToCart(){
    ...
    XLSX.writeFile(wb, 'ClinicNonManagerReport.xlsx'); 
  }
